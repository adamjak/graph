...
public class GraphUtilsTest
{
	...
	@Test
	public void checkIsomorphismTest () throws Exception
	{
		Vertex<Integer> v1 = new VertexImpl<Integer>(1);
		Vertex<Integer> v2 = new VertexImpl<Integer>(2);
		Vertex<Integer> v3 = new VertexImpl<Integer>(3);
		...
		Edge<Integer> e3 = new EdgeImpl<Integer>(3, v3, v4, false);
		Edge<Integer> e4 = new EdgeImpl<Integer>(4, v2, v4, false);
		Edge<Integer> e5 = new EdgeImpl<Integer>(5, v1, v4, false);
		...
		Graph<Integer> g2 = GraphImpl.createGraph(Integer.class);
		g2.addVertex(v1);
		g2.addVertex(v4);
		g2.addVertex(v3);
		g2.addVertex(v2);
		...
		Graph<Integer> g3 = GraphImpl.createGraph(Integer.class);
		g3.addVertex(v1);
		g3.addVertex(v2);
		g3.addVertex(v3);
		g3.addVertex(v4);
		...
		assertTrue(GraphUtils.checkIsomorphism(g1, g2));
